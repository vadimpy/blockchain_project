...
const Map: React.FC<IMap> = ({ mapType, mapTypeControl = false, setDistanceInKm}) => {
    ...
    const startMap = (): void => {
        if (!map) {
            ...
            const homeLocation = new google.maps.LatLng(42.36767226766624, -71.25834435669445);
    ...
    const defaultMapStart = (): void => {
        const defaultAddress = new google.maps.LatLng(42.36767226766624, -71.25834435669445);
        initMap(4, defaultAddress);
    };

    const initEventListener = ():void => {
        if (map) {
            google.maps.event.addListener(map, 'click', function(e: { latLng: google.maps.LatLng; }) {
